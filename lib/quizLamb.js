...
export function InitGame(score){
    SetScore(score);
    //http://localhost:3000/
    AddNewDraggableObject(new DraggableObject("FrenchedRibs", "FrenchedRibs"));
    AddNewDraggableObject(new DraggableObject("Shank", "Shank"));
    //AddNewDraggableObject(new DraggableObject("Blender", "Blender"));


    FinalizeItems("Game_Lamb.glb", "empty_warehouse_01_1k copy.hdr", "Game", "Place the cuts on the correct part of the anatomy"); //, "temp", "Reassemble Blender In Order"
