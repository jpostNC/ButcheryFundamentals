...
export function InitGame(score){
    ...
    //http://localhost:3000/
    AddNewDraggableObject(new DraggableObject("RibChop", "RibChop"));
    AddNewDraggableObject(new DraggableObject("Tenderloin", "Tenderloin"));

    //AddNewDraggableObject(new DraggableObject("Blender", "Blender"));


    FinalizeItems("Game_Beef.glb", "empty_warehouse_01_1k copy.hdr", "Game", "Place the cuts on the correct part of the anatomy"); //, "temp", "Reassemble Blender In Order"
