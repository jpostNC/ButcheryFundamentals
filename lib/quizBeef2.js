...
export function InitGame(score){
    SetScore(score, 2);
    //http://localhost:3000/
    AddNewDraggableObject(new DraggableObject("Ossobuco", "Ossobuco"));
    AddNewDraggableObject(new DraggableObject("Striploin", "Striploin"));

    //AddNewDraggableObject(new DraggableObject("Blender", "Blender"));


    FinalizeItems("Game_Beef2.glb", "empty_warehouse_01_1k copy.hdr", "Game", "Place the cuts on the correct part of the anatomy"); //, "temp", "Reassemble Blender In Order"
    ...
    const leftLight = new THREE.PointLight(0xFFFFFF, 0, 0);
