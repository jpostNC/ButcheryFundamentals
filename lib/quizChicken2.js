...
export function InitGame(score){
    ...
    AddNewDraggableObject(new DraggableObject("Thigh", "Thigh"));

    //AddNewDraggableObject(new DraggableObject("Blender", "Blender"));


    FinalizeItems("game_Chicken2.glb", "empty_warehouse_01_1k copy.hdr", "ChickenGame2", "Place the cuts on the correct part of the anantomy"); //, "temp", "Reassemble Blender In Order"
